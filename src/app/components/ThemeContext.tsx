...
export const defaultLightColors: ThemeColors = {
  ...
  cardBg: "#FFFFFF",
  cardShadow: "0 1px 2px rgba(15,15,15,0.04), 0 6px 18px rgba(15,15,15,0.05)",
  cardShadowHover: "0 12px 40px rgba(15,15,15,0.10), 0 2px 6px rgba(15,15,15,0.04)",
  shimmer: "#F1F1F1",
  imageBg: "#F4F4F4",
  gridLine: "rgba(0,0,0,0.035)",
  rippleColor: { r: 26, g: 81, b: 244 },
};
